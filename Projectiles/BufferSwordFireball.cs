...
namespace Testspada.Projectiles
{
    public class BuffSwordFireball : ModProjectile
    {
        ...
        {
            Terraria.Audio(SoundID.CreateTrackable("dd2_betsy_fireball_impact", 3, SoundType.SoundID), (int)projectile.position.X, (int)projectile.position.Y;)); // Play a death sound
