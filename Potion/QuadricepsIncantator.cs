...
{
	public class QuadricepsIncantator : ModItem
	{
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Quadriceps Incantator");
            Tooltip.SetDefault("Gives the Ultra Swiftness buffs, this strengthens your legs");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.buffType = ModContent.BuffType<Buffs.UltraSwiftness>(); //Specify an existing buff to be applied when used.
