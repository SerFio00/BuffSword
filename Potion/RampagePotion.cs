...
{
	public class RampagePotion : ModItem
	{
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Potio Furoris");
            Tooltip.SetDefault("Gives the Minion Rampage buffs, Minions are in Rampage mode");
        }
        ...
        public override void SetDefaults()
        {
            ...
            item.buffType = ModContent.BuffType<Buffs.MinionRampage>(); //Specify an existing buff to be applied when used.
